export interface ResetPasswordLocalization {
    /**
    ...
    resetPassword: {
        ...
        failedTitle: string;
        /**
         * Description message to be displayed if reset password failed
         */
        failedMessage: string;
        /**
         * Back to login button text in reset passwrod failed section
         */
