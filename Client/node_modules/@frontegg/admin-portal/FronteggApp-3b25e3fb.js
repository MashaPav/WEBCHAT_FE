...
class FronteggApp {
    constructor(_options, name, iframeRendering = false) {
        ...
        this.store = (_a = this.options.store) !== null && _a !== void 0 ? _a : createFronteggStore({ context: this.options.contextOptions }, this, this.options.previewMode, authOptions, {
    ...
    initContainers(elements) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.options.previewMode && !this.options.customLoginBox) {
                setTimeout(() => {
                    const loginBoxComponent = React.lazy(() => import('./index-f432917b.js'));
    ...
    showAdminPortal() {
        const adminPortalComponent = React.lazy(() => import('./index-e4d8b997.js'));
    ...
    showCheckoutDialog(opts) {
        const checkoutDialogComponent = React.lazy(() => import('./index-e4d8b997.js').then(({ CheckoutDialog }) => ({ default: CheckoutDialog })));
...
export { FronteggApp as F, React as R, __extends as _, ReactDom as a, __read as b, __values as c, __assign as d, __spread as e, __rest as f, __awaiter as g, reactDom as h, react as r };
