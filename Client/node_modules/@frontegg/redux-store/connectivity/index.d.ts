...
declare const _default: {
    ...
    actions: {
        ...
        postDataAction: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("../interfaces").WithCallback<import("./interfaces").TPostData, boolean>], import("../interfaces").WithCallback<import("./interfaces").TPostData, boolean>, string, never, never>;
        ...
        deleteWebhookConfigAction: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("../interfaces").WithCallback<{
            webhookId: string;
        }, boolean>], import("../interfaces").WithCallback<{
            webhookId: string;
        }, boolean>, string, never, never>;
        postWebhookTestAction: import("@reduxjs/toolkit").ActionCreatorWithPreparedPayload<[import("../interfaces").WithCallback<import("@frontegg/rest-api").IWebhookTest, boolean>], import("../interfaces").WithCallback<import("@frontegg/rest-api").IWebhookTest, boolean>, string, never, never>;
